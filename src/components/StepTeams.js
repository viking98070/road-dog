...
const TEAM_COLORS = {
  ...
  Michigan:'#00274C','Michigan St.':'#18453B',Minnesota:'#7A0019',Mississippi:'#CE1126',
  'Mississippi St.':'#5D1F1A',Missouri:'#F1B82D',Nebraska:'#E41C38','North Carolina':'#7BAFD4',
  'North Carolina St.':'#CC0000',Northwestern:'#4E2A84','Notre Dame':'#0C2340',
  'Ohio State':'#BB0000',Oklahoma:'#841617','Oklahoma St.':'#FF7300','Ole Miss':'#CE1126',
  Oregon:'#154733','Oregon St.':'#CC0000','Penn State':'#041E42',Pittsburgh:'#003594',
  Purdue:'#CEB888',Rutgers:'#CC0033',SMU:'#0033A0','South Carolina':'#73000A',
  Stanford:'#8C1515',Syracuse:'#D44500',TCU:'#4D1979',Tennessee:'#FF8200',Texas:'#BF5700',
  'Texas A&M':'#500000','Texas Tech':'#CC0000',UCLA:'#2D68C4',USC:'#990000',Utah:'#CC0000',
  Vanderbilt:'#866D4B',Virginia:'#232D4B','Virginia Tech':'#630031','Wake Forest':'#9E7E38',
  ...
  Xavier:'#002883','San Diego St.':'#C41230',Memphis:'#003087',
  ...
  'Real Salt Lake':'#B30838','San Jose Earthquakes':'#0D4C92','Seattle Sounders':'#5D9741',
  'Sporting KC':'#002F65','St. Louis City':'#DC1B34','Toronto FC':'#B81137',
  'Vancouver Whitecaps':'#009BC8',
}
  Bears:'#0B162A',Bengals:'#FB4F14',Bills:'#00338D',Broncos:'#FB4F14',Browns:'#311D00',
  Buccaneers:'#D50A0A',Cardinals:'#97233F',Chargers:'#0080C6',Chiefs:'#E31837',Colts:'#002C5F',
  Cowboys:'#003594',Dolphins:'#008E97',Eagles:'#004C54',Falcons:'#A71930',Giants:'#0B2265',
